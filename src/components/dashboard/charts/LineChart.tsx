  ...
  return (
    <div className="bg-(--color-bg-light) dark:bg-(--color-bg-white-opacity) rounded-2xl p-4 sm:p-6 h-full flex flex-col">
      <div className="flex items-center gap-2 sm:gap-4 mb-3 sm:mb-4 flex-wrap text-xs">
        ...
        <span className="text-(--color-text-primary-opacity-33) dark:text-(--color-text-white-opacity-33) hidden sm:inline">
          |
        </span>
        <div className="flex items-center gap-1 sm:gap-2">
          <CircleIcon className="text-(--color-text-primary) dark:text-(--color-chart-dark-purple)" />
          <span className="text-black dark:text-white text-xs">Current Week: $58,211</span>
        </div>
        <div className="flex items-center gap-1 sm:gap-2">
          <CircleIcon className="text-(--color-chart-primary) dark:text-(--color-chart-primary)" />
