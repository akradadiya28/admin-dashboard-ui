...
export default function OrderListTable() {
  ...
  return (
    <div className="p-4 sm:p-5 md:p-7">
      ...
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3 sm:gap-2 mb-4 sm:mb-6 bg-(--color-bg-light) dark:bg-(--color-bg-white-opacity) rounded-lg p-2 sm:p-3">
          ...
          <div className="relative">
            ...
            {isFilterOpen && (
              <>
                ...
                <div className="absolute top-10 left-0 z-20 bg-white dark:bg-(--color-bg-dark-alt) rounded-lg border border-black/10 dark:border-white/10 shadow-lg min-w-[200px] p-3">
        ...
        <div className="relative w-full sm:w-auto">
          ...
          <input
            ...
            className="pl-10 pr-4 py-2 w-full sm:w-64 rounded-lg border border-black/10 dark:border-white/10 bg-white dark:bg-(--color-bg-dark-alt) text-sm text-black dark:text-white placeholder:text-black/40 dark:placeholder:text-white/40 focus:outline-none focus:ring-2 focus:ring-black/10 dark:focus:ring-white/10"
          />
        </div>
      </div>
                ...
                <tr
                  ...
                  className={`border-b border-black/5 dark:border-white/5 last:border-0 transition-all duration-200 ${
                    hoveredRow === order.id || selectedOrders.has(order.id)
                      ? 'bg-(--color-bg-light) dark:bg-white/5 rounded-xl shadow-sm'
              ...
              return (
                <button
                  ...
                  className={`px-3 py-1 text-sm rounded transition-colors ${
                    currentPage === pageNum
                      ? 'bg-(--color-text-primary-opacity-05) dark:bg-white/10 text-black dark:text-white font-semibold'
