...
export default function NotificationPanel() {
  ...
  return (
    <aside className="w-full sm:w-[280px] border-l border-black/10 dark:border-white/10 bg-white dark:bg-(--color-bg-dark-alt) flex flex-col p-4 sm:p-5 gap-4 sm:gap-6 overflow-y-auto h-screen fixed md:sticky top-0 right-0 scrollbar-auto-hide z-30 md:z-auto">
